...
export async function seedEasyDatabase() {
  ...
  try {
    ...
    await insert(database, 'witnesses', ['id', 'name', 'relationship', 'statement', 'reliability'], [
      ...
      [4, 'Victor Shaw', 'Security Officer', '“I saw Daniel near the lab at about ten past ten. At quarter past ten I was answering a call on the east stairs.”', 'High'],
    ...
    await insert(database, 'cctv_logs', ['id', 'camera_id', 'observed_at', 'subject', 'observation'], [
      ...
      [8, 'EAST-STAIR-01', '2026-10-14 22:18:00', 'Victor Shaw', 'Victor answers a radio call on the east stairwell landing.'],
    ...
    await insert(database, 'vehicles', ['id', 'owner_name', 'vehicle_type', 'registration', 'last_seen'], [
      ...
      [5, 'Daniel Reed', 'Blue sedan', 'HWP-822', 'Service lot, 10:28 PM — left campus ten minutes after the murder'],
    ]);
