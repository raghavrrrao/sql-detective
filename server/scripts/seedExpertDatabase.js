...
export async function seedExpertDatabase() {
  ...
  try {
    ...
    await insert(database, 'cctv_logs', ['id', 'camera_id', 'observed_at', 'subject', 'observation'], [
      ...
      [15, 'MESS-01', '2026-12-19 01:05:00', 'Isla Bennet', 'Bennet is at the long table in the crew mess with four other crew.'],
      [12, 'BRIDGE-01', '2026-12-19 01:15:00', 'Leila Moreau', 'Moreau signs off the bridge and goes below.'],
      [13, 'DECK7-AFT', '2026-12-19 01:22:00', 'Kieran Holt', 'Holt enters the Deck 7 corridor with a service tray and goes forward.'],
      [14, 'MESS-01', '2026-12-19 01:26:00', 'Isla Bennet', 'Bennet is still in the crew mess when the general alarm sounds.'],
    ]);
    ...
    await insert(database, 'access_logs', ['id', 'person_name', 'access_point', 'access_time', 'result'], [
      ...
      [2, 'Renata Silva', 'Deck 7 lobby panel', '2026-12-18 23:52:00', 'Granted'],
