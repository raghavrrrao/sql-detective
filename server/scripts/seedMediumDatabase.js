...
/**
 * Case 04 — The Mansion at Blackwood Hill.
 *
...
export async function seedMediumDatabase() {
  ...
  try {
    ...
    await insert(database, 'witnesses', ['id', 'name', 'relationship', 'statement', 'reliability'], [
      ...
      [8, 'Wilf Danby', 'Footman', '“Mr Vane came into the drawing room about ten to ten, red in the face and out of breath. He had no overcoat, and he had worn it all evening.”', 'High'],
    ...
    await insert(database, 'employees', ['id', 'name', 'department', 'role', 'shift'], [
      ...
      [5, 'Wilf Danby', 'Household', 'Footman', 'Evening'],
    ]);
